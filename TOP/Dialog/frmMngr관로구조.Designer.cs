...
namespace TOP.Dialog
{
    partial class frmMngr관로구조
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMngr관로구조));
            ...
            // gridControl3
            // 
            this.gridControl3.DataMember = "QRY_관로구조_LIST";
            ...
            customSqlQuery1.Name = "QRY_관로_LIST";
            customSqlQuery1.Sql = "select cd\r\n      ,cd_nm\r\n\t,descr\r\n  from cod10m00\r\n where mngr_cd = \'PIPE_ROAD\'\r\n" +
    " ORDER BY ORD_SEQ";
            customSqlQuery2.Name = "QRY_관로구조_LIST";
            customSqlQuery2.Sql = "select MNGR_CD\r\n      ,CD\r\n      ,CD_NM\r\n      ,DESCR\r\n  from cod10m00\r\n where mn" +
    "gr_cd = \'PIPE_R_CD\'";
            customSqlQuery3.Name = "QRY_관로별_구조_LIST";
            ...
            // gridControl2
            // 
            this.gridControl2.DataMember = "QRY_관로별_구조_LIST";
            ...
            // gridControl1
            // 
            this.gridControl1.DataMember = "QRY_관로_LIST";
            ...
            this.layoutControlItem1.Text = "관로";
            ...
            this.layoutControlItem2.Text = "관로별_구조 LIST";
            ...
            this.layoutControlItem3.Text = "관로구조 LIST";
            ...
            customSqlQuery4.Name = "관로별구조_DELETE";
            ...
            customSqlQuery4.Sql = "DELETE FROM COD12T00 \r\nWHERE PROJECT_CD = @P_PROJECT_CD\r\n  AND P_MNGR_CD = @P_P_M" +
    "NGR_CD\r\n  AND P_CD      = @P_P_CD";
            customSqlQuery5.Name = "관로별구조_INSERT";
            ...
            customSqlQuery5.Sql = "INSERT INTO COD12T00 (project_cd, p_mngr_cd, p_cd, mngr_cd, cd, ord_seq, cd_val)\r" +
    "\nSELECT @P_PROJECT_CD\r\n      ,@P_P_MNGR_CD\r\n \t,@P_P_CD\r\n\t,@P_MNGR_CD\r\n\t,@P_CD\r\n\t" +
    ",@P_ORD_SEQ\r\n\t,@P_CD_VAL";
            this.sqlData.Queries.AddRange(new DevExpress.DataAccess.Sql.SqlQuery[] {
            customSqlQuery4,
            customSqlQuery5});
            this.sqlData.ResultSchemaSerializable = "PERhdGFTZXQgTmFtZT0ic3FsRGF0YSI+PFZpZXcgTmFtZT0i6rSA66Gc67OE6rWs7KGwX0RFTEVURSIgL" +
    "z48VmlldyBOYW1lPSLqtIDroZzrs4TqtazsobBfSU5TRVJUIiAvPjwvRGF0YVNldD4=";
            // 
            // frmMngr관로구조
            // 
