...
namespace TOP.Dialog
{
    partial class frmMngr포장구조
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMngr포장구조));
            ...
            // gridControl3
            // 
            this.gridControl3.DataMember = "QRY_포장구조_LIST";
    ...
    "RDER BY ORD_SEQ";
            customSqlQuery2.Name = "QRY_포장구조_LIST";
            customSqlQuery2.Sql = "select MNGR_CD\r\n      ,CD\r\n      ,CD_NM\r\n      ,DESCR\r\n  from cod10m00\r\n where mn" +
    "gr_cd = \'PAVE_ST_CD\'";
            customSqlQuery3.Name = "QRY_포장별_구조_LIST";
            ...
            // gridControl2
            // 
            this.gridControl2.DataMember = "QRY_포장별_구조_LIST";
            ...
            this.layoutControlItem3.Text = "맨홀구조 LIST";
            ...
            customSqlQuery4.Name = "포장별구조_DELETE";
            ...
            customSqlQuery4.Sql = "DELETE FROM COD13T00 \r\nWHERE PROJECT_CD = @P_PROJECT_CD\r\n  AND P_MNGR_CD = @P_P_M" +
    "NGR_CD\r\n  AND P_CD      = @P_P_CD";
            customSqlQuery5.Name = "포장별구조_INSERT";
            ...
            customSqlQuery5.Sql = "INSERT INTO COD13T00 (project_cd, p_mngr_cd, p_cd, mngr_cd, cd, ord_seq, cd_val)\r" +
    "\nSELECT @P_PROJECT_CD\r\n      ,@P_P_MNGR_CD\r\n \t,@P_P_CD\r\n\t,@P_MNGR_CD\r\n\t,@P_CD\r\n\t" +
    ",@P_ORD_SEQ\r\n\t,@P_CD_VAL";
            this.sqlData.Queries.AddRange(new DevExpress.DataAccess.Sql.SqlQuery[] {
            customSqlQuery4,
            customSqlQuery5});
            this.sqlData.ResultSchemaSerializable = "PERhdGFTZXQgTmFtZT0ic3FsRGF0YSI+PFZpZXcgTmFtZT0i7Y+s7J6l67OE6rWs7KGwX0RFTEVURSIgL" +
    "z48VmlldyBOYW1lPSLtj6zsnqXrs4TqtazsobBfSU5TRVJUIiAvPjwvRGF0YVNldD4=";
            // 
            // frmMngr포장구조
            // 
